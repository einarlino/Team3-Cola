    ...
    document.getElementById('app').innerHTML = /*HTML*/`
        <div class="flexVertical">
            <div class="flexHorizontal">
                <div class="automat">
                    <h1>Øl-automat - pris: 25kr</h1>
                    <div class="innmat">
                        ${getCoinsHtml(wallet)}
                        <div class="cokes">
                            ${repeatImgDivHtml('beer', 'beer', beersInStore)}
                        </div>
                        <div>
                ...
                <div>
                    Mynt- og øl-utkast: ${valueFromCoinCounts(coinsReturned)}kr
                    ${getCoinsHtml(coinsReturned)}
                    ${repeatImgDivHtml('beer', 'beer', isBeerInDelivery ? 1 : 0)}
            ...
            <div class="flexHorizontal">
                    ...
                    <button onclick="buyBeer()">Kjøpe øl</button>
                    <button onclick="takeBeer()">Ta øl</button>
                    </div>
